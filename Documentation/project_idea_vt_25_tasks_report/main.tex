...
The app will include recurring tasks, custom task categories, reminders, and priority levels. Dependencies between tasks will be displayed visually, helping users understand how their tasks relate to one another.

The application is focused on improving mental health stability with focus on SDG 4.3.2 \site{ worldhealthorganisation_2024_sdg}.
